    ...
    <div class="w-full max-w-5xl bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.08)] flex overflow-hidden">
        ...
        <div class="w-full md:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
            ...
            <a href="{{ url('/') }}" class="flex items-center gap-2 mb-10 hover:opacity-80 transition inline-block w-max">
                ...
                <span class="font-extrabold text-2xl tracking-tight text-dark uppercase">Klinik<span class="text-primary">Bina Usada</span></span>
            </a>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="email@contoh.com" class="w-full pl-11 pr-4 py-3.5 rounded-xl border border-gray-300 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition text-gray-700 bg-gray-50 focus:bg-white">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="password" type="password" name="password" required placeholder="••••••••" class="w-full pl-11 pr-12 py-3.5 rounded-xl border border-gray-300 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition text-gray-700 bg-gray-50 focus:bg-white">
        ...
        <div class="hidden md:block w-1/2 relative bg-primary">
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/40 to-transparent flex flex-col justify-end p-12 text-white">
                <div class="bg-white/20 backdrop-blur-md p-6 rounded-2xl border border-white/30">
                    <h3 class="text-xl font-bold mb-2 uppercase">Layanan Terpadu</h3>
